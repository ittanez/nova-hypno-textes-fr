  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Politique de confidentialité de l'application de respiration guidée NovaRespire : données traitées, durées de conservation, suppression et vos droits." />
