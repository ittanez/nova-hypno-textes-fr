...
const deuilFaqItems = [
  ...
  },
  {
    ...
    answer: "Oui. Les séances en visioconférence sont aussi efficaces qu'en cabinet pour accompagner le processus de deuil. Nombreux de mes patients en deuil apprécient la visio car elle leur permet d'être dans un environnement familier et sécurisant, sans avoir à se déplacer dans un état émotionnel parfois fragile."
  }
];
