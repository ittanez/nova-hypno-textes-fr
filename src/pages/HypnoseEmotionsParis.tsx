...
const HypnoseEmotionsParis = () => {
  ...
  const emotionTypes: { title: string; desc: string; href?: string }[] = [
    ...
    { title: "Traumatismes", desc: "Choc, accident, agression : reviviscences, hypervigilance, évitement", href: "/hypnose-traumatismes-paris" },
  ...
  return (
    <CzLayout>
      <Helmet>
        ...
        <meta name="description" content="Gérez vos émotions par l'hypnose à Paris 4ème ou en visio partout en France. Colère, hypersensibilité, deuil, frustration. Alain Zenatti, Maître Hypnologue." />
