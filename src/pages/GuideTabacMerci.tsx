...
/* ─────────────────────────────────────────────
   Thank You page — guide "Arrêt du Tabac, Votre Liberté Retrouvée"
   Charte ZENatti / risographie — ambre · cobalt · lin
   ───────────────────────────────────────────── */

const GuideTabacMerci: React.FC = () => {
  ...
  useEffect(() => {
    if (!location.state) { navigate('/guide-arret-tabac', { replace: true }); }
  ...
  return (
    <>
      <Helmet>
        <title>Merci ! Guide Arrêt du Tabac envoyé — NovaHypnose</title>
        <meta name="robots" content="noindex, nofollow" />
        <link rel="canonical" href="https://novahypnose.fr/guide-arret-tabac/merci" />
      </Helmet>

      <div className="cz">
        <svg width="0" height="0" style={{ position: 'absolute' }} aria-hidden="true">
          <defs>
            <filter id="riso-full-tm">
            ...
            <filter id="paperGrain-tm" x="0" y="0" width="100%" height="100%">
        ...
        <section style={{ position: 'relative', overflow: 'hidden', padding: '100px 0 80px', minHeight: '60vh', display: 'flex', alignItems: 'center' }}>
          <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
            <svg width="100%" height="100%" viewBox="0 0 1440 600" preserveAspectRatio="xMidYMid slice">
              ...
              <g filter="url(#riso-full-tm)" style={{ mixBlendMode: 'multiply' }}>
              ...
              <rect width="1440" height="600" filter="url(#paperGrain-tm)" opacity=".15" />
            </svg>
          </div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
                  ...
                  <div>
                    <p style={{ fontFamily: 'var(--f-serif)', fontSize: '18px', fontWeight: 400, color: 'var(--texte)', marginBottom: '6px' }}>
                      Votre guide « Arrêt du Tabac, Votre Liberté Retrouvée » arrive par email
                    </p>
...
export default GuideTabacMerci;
