...
/* ─────────────────────────────────────────────
   Thank You page — guide "Libérez-vous de la Procrastination"
   Charte ZENatti / risographie — ambre · cobalt · lin
   ───────────────────────────────────────────── */

const GuideProcrastinationMerci: React.FC = () => {
  ...
  useEffect(() => {
    if (!location.state) { navigate('/guide-procrastination', { replace: true }); }
      ...
      <div className="cz">
        <svg width="0" height="0" style={{ position: 'absolute' }} aria-hidden="true">
          <defs>
            ...
            <filter id="paperGrain-pm" x="0" y="0" width="100%" height="100%">
        ...
        <section style={{ position: 'relative', overflow: 'hidden', padding: '100px 0 80px', minHeight: '60vh', display: 'flex', alignItems: 'center' }}>
          <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
            <svg width="100%" height="100%" viewBox="0 0 1440 600" preserveAspectRatio="xMidYMid slice">
              <g filter="url(#riso-full-pm)">
                <path d="M 200 0 L 600 0 C 680 80, 680 180, 620 240 C 540 320, 360 320, 240 260 C 100 200, 60 80, 200 0 Z" fill="#F2A12E" opacity="0.55" />
              </g>
              <g filter="url(#riso-full-pm)" style={{ mixBlendMode: 'multiply' }}>
                <path d="M 1200 400 C 1300 320, 1420 300, 1480 340 L 1480 600 L 800 600 C 840 520, 960 460, 1200 400 Z" fill="#2B4BA0" opacity="0.6" />
              </g>
              <rect width="1440" height="600" filter="url(#paperGrain-pm)" opacity=".15" />
            </svg>
          </div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
                  ...
                  <div>
                    <p style={{ fontFamily: 'var(--f-serif)', fontSize: '18px', fontWeight: 400, color: 'var(--texte)', marginBottom: '6px' }}>
                      Votre guide « Libérez-vous de la Procrastination » arrive par email
                    </p>
...
export default GuideProcrastinationMerci;
