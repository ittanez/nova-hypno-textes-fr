...
import { submitColereLead } from '@/lib/services/colereLeadService';
...
/* ─────────────────────────────────────────────
   Landing page isolée — Guide "La Colère, Enfin Apprivoisée"
...
const chapters = [
  { title: "Pourquoi la colère explose avant que vous ne puissiez réagir", desc: "Comment l'inconscient déclenche la réponse automatique, bien avant que la conscience n'intervienne." },
  { title: 'Ce que votre colère essaie de vous dire', desc: "Décoder le signal derrière l'émotion : besoin non satisfait, limite franchie, blessure ancienne." },
  { title: 'Les déclencheurs invisibles de l\'irritabilité chronique', desc: "Identifier les schémas répétitifs qui vous mettent à fleur de peau sans que vous en ayez conscience." },
  { title: 'La technique du recul : reprendre la main avant l\'explosion', desc: "Un protocole d'auto-hypnose simple pour installer un espace de choix entre le déclencheur et la réaction." },
  { title: 'Sortir du cycle culpabilité — rechute', desc: "Comment désamorcer la honte après-coup pour qu'elle n'alimente plus la prochaine explosion." },
];

const GuideColere: React.FC = () => {
  const rootRef = useRef<HTMLDivElement>(null);
  const navigate = useNavigate();
  const handleSuccess = useCallback((prenom: string) => {
    navigate('/guide-colere/merci', { state: { prenom } });
  }, [navigate]);
    ...
    <>
      <Helmet>
        ...
        <script type="application/ld+json">{safeJSONStringify({
          ...
          "@id": "https://novahypnose.fr/guide-colere#book",
          ...
          "url": "https://novahypnose.fr/guide-colere", "inLanguage": "fr-FR",
      ...
      <div className="cz" ref={rootRef}>
        <svg width="0" height="0" style={{ position: 'absolute' }} aria-hidden="true">
          <defs>
            <filter id="riso-full-c">
              <feTurbulence type="turbulence" baseFrequency="0.018 0.022" numOctaves={2} seed={11} result="turb" />
            ...
            <filter id="paperGrain-c" x="0" y="0" width="100%" height="100%">
        ...
        <section className="hero" style={{ paddingTop: '80px' }}>
          <div className="hero__bg" aria-hidden="true">
            <svg viewBox="0 0 1440 1000" preserveAspectRatio="xMidYMid slice">
              <g filter="url(#riso-full-c)">
                <path d="M 1440 0 L 900 0 C 800 60, 760 150, 800 250 C 840 350, 960 410, 1120 420 C 1260 428, 1400 380, 1440 280 Z" fill="#2B4BA0" opacity="0.85" />
              </g>
              <g filter="url(#riso-full-c)" style={{ mixBlendMode: 'multiply' }}>
                <path d="M 0 620 C 120 540, 300 500, 480 540 C 620 570, 720 650, 780 740 C 840 830, 800 940, 720 1000 L 0 1000 Z" fill="#F2A12E" opacity="0.75" />
              </g>
              <rect width="1440" height="1000" filter="url(#paperGrain-c)" opacity=".2" />
            </svg>
          </div>

          <div className="zen-mark" aria-hidden="true">apaisée</div>
          ...
          <div className="container" style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: '60px', alignItems: 'center', paddingBottom: '100px', position: 'relative', zIndex: 5, width: '100%' }}>
            <div className="reveal hero__panel" style={{ transitionDelay: '.1s' }}>
              ...
              <h1 style={{ fontFamily: 'var(--f-serif)', fontSize: 'clamp(32px, 4.5vw, 56px)', fontWeight: 300, lineHeight: 1.08, color: 'var(--texte)', margin: '0 0 16px', letterSpacing: '-0.02em' }}>
                La Colère,<br />
                <em style={{ fontStyle: 'italic', color: 'var(--cobalt)', fontWeight: 400 }}>Enfin Apprivoisée</em>
              </h1>
              ...
              <p style={{ fontFamily: 'var(--f-serif)', fontStyle: 'italic', fontWeight: 300, fontSize: 'clamp(16px, 1.8vw, 21px)', color: 'var(--texte)', marginBottom: '28px', lineHeight: 1.55, maxWidth: '460px' }}>
                Elle explose avant que vous ne puissiez réagir. <em style={{ color: 'var(--cobalt)' }}>Reprenez la main — sans la supprimer.</em>
              </p>
        ...
        <section style={{ background: 'var(--lin-2)', padding: '80px 0' }}>
          <div className="container">
            <div className="reveal" style={{ marginBottom: '40px' }}>
              ...
              <h2 className="section-title">Ce que vit une colère<br /><em>mal apprivoisée.</em></h2>
            </div>
        ...
        <section style={{ background: 'var(--lin)', padding: '80px 0' }}>
          <div className="container" style={{ maxWidth: '780px', margin: '0 auto' }}>
            <div className="reveal" style={{ marginBottom: '40px' }}>
              ...
              <h2 className="section-title">Un guide pour apaiser la colère,<br /><em>sans la supprimer.</em></h2>
          ...
          <div className="container" style={{ maxWidth: '780px', margin: '0 auto' }}>
            <div className="reveal">
              ...
              <p style={{ fontFamily: 'var(--f-serif)', fontStyle: 'italic', color: 'var(--texte)', fontSize: 'clamp(18px, 2vw, 24px)', lineHeight: 1.5, marginBottom: '32px' }}>
                « La colère n'est pas votre ennemie.<br />
                C'est sa version incontrôlée qui vous fait du mal. »
              </p>
