...
const Maquette = () => {
  ...
  return (
    <ContentLayout>
      ...
      {/* Section Comment je peux vous aider - RÉSUMÉ */}
      <section id="comment-aider" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              L'hypnose ericksonienne est une approche thérapeutique douce et efficace
              pour accompagner les changements que vous souhaitez dans votre vie
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Stress & Anxiété</h3>
              <p className="text-gray-600 leading-relaxed">
                Retrouvez calme et sérénité. Libérez-vous du stress chronique et de l'anxiété qui vous paralysent.
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Confiance en soi</h3>
              <p className="text-gray-600 leading-relaxed">
                Développez une confiance authentique. Libérez-vous de vos blocages émotionnels et affirmez-vous.
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Objectifs de vie</h3>
              <p className="text-gray-600 leading-relaxed">
                Mobilisez vos ressources inconscientes pour atteindre vos objectifs personnels et professionnels.
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Addictions & Habitudes</h3>
              <p className="text-gray-600 leading-relaxed">
                Libérez-vous du tabac, de la nourriture émotionnelle et développez de nouvelles habitudes positives.
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Phobies & Peurs</h3>
              <p className="text-gray-600 leading-relaxed">
                Surmontez vos peurs et phobies avec une approche douce, progressive et bienveillante.
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Relations & Communication</h3>
              <p className="text-gray-600 leading-relaxed">
                Améliorez vos relations interpersonnelles et développez des compétences de communication authentiques.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-6 order-1 md:order-2">
                ...
                <p className="text-xl text-blue-600 font-semibold">
                  Maître Hypnologue certifié • Paris 4ème
                </p>

                <div className="bg-blue-50 p-6 rounded-xl border-l-4 border-blue-500">
                  <p className="font-semibold text-gray-900 mb-2">Pourquoi choisir un Maître Hypnologue ?</p>
                  <p className="text-gray-700 leading-relaxed">
      ...
      <section id="self-hypnosis" className="py-20 bg-gradient-to-br from-blue-50 to-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-12 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto mb-16">
            <div>
              <h3 className="text-2xl font-semibold text-blue-600 mb-4">Pourquoi apprendre l'auto-hypnose ?</h3>
              <p className="mb-4 text-gray-700 leading-relaxed">
                L'auto-hypnose est une compétence précieuse qui vous permettra de prolonger et d'approfondir les bienfaits des séances avec votre hypnothérapeute.
              </p>
              <p className="mb-4 text-gray-700 leading-relaxed">
                Une fois maîtrisée, cette technique devient un outil puissant pour gérer votre stress, améliorer votre sommeil, renforcer votre confiance et cultiver un état de bien-être au quotidien.
              </p>
              <p className="mb-8 text-gray-700 leading-relaxed">
                Je vous propose d'apprendre des techniques simples et efficaces, adaptées à vos besoins spécifiques, que vous pourrez pratiquer en toute autonomie.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <h4 className="text-xl font-semibold text-gray-900 mb-3">Auto-hypnose pour le stress</h4>
              <p className="text-gray-600">
                Apprenez à entrer rapidement dans un état de calme profond, même au milieu des situations les plus stressantes.
              </p>
            </div>

            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <h4 className="text-xl font-semibold text-gray-900 mb-3">Auto-hypnose pour le sommeil</h4>
              <p className="text-gray-600">
                Découvrez des techniques puissantes pour améliorer la qualité de votre sommeil et installer un rituel apaisant.
              </p>
            </div>

            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <h4 className="text-xl font-semibold text-gray-900 mb-3">Auto-hypnose pour la confiance</h4>
              <p className="text-gray-600">
                Renforcez votre estime personnelle grâce à des exercices d'ancrage et de visualisation positive.
              </p>
            </div>
          </div>
        </div>
