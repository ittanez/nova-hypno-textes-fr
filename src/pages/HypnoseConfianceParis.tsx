  ...
  return (
    <ContentLayout>
      <Helmet>
        ...
        <meta name="twitter:description" content="Développez votre confiance en soi grâce à l'hypnose ericksonienne à Paris. Syndrome de l'imposteur, prise de parole, estime de soi." />
