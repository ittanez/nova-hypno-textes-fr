  ...
  return (
    <CzLayout>
      <Helmet>
        ...
        <meta name="description" content="Spécialiste de l'hypnose en visioconférence partout en France. Alain Zenatti, Maître Hypnologue certifié, propose des téléconsultations d'hypnose." />
