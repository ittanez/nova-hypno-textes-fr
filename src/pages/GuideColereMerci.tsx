...
/* ─────────────────────────────────────────────
   Thank You page — guide "La Colère, Enfin Apprivoisée"
   Charte ZENatti / risographie — ambre · cobalt · lin
   ───────────────────────────────────────────── */

const GuideColereMerci: React.FC = () => {
  ...
  useEffect(() => {
    if (!location.state) { navigate('/guide-colere', { replace: true }); }
  ...
  return (
    <>
      <Helmet>
        <title>Merci ! Guide Colère envoyé — NovaHypnose</title>
        <meta name="robots" content="noindex, nofollow" />
        <link rel="canonical" href="https://novahypnose.fr/guide-colere/merci" />
      </Helmet>

      <div className="cz">
        <svg width="0" height="0" style={{ position: 'absolute' }} aria-hidden="true">
          <defs>
            <filter id="riso-full-cm">
              <feTurbulence type="turbulence" baseFrequency="0.018 0.022" numOctaves={2} seed={12} result="turb" />
              <feDisplacementMap in="SourceGraphic" in2="turb" scale={6} result="displaced" />
              <feTurbulence type="fractalNoise" baseFrequency="0.72 0.75" numOctaves={4} seed={17} result="noise" />
              <feColorMatrix type="saturate" values="0" in="noise" result="grey" />
              <feBlend in="displaced" in2="grey" mode="multiply" result="out" />
              <feComposite in="out" in2="displaced" operator="in" />
            </filter>
            <filter id="paperGrain-cm" x="0" y="0" width="100%" height="100%">
              <feTurbulence type="fractalNoise" baseFrequency=".72" numOctaves={4} seed={6} />
        ...
        <section style={{ position: 'relative', overflow: 'hidden', padding: '100px 0 80px', minHeight: '60vh', display: 'flex', alignItems: 'center' }}>
          <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
            <svg width="100%" height="100%" viewBox="0 0 1440 600" preserveAspectRatio="xMidYMid slice">
              <g filter="url(#riso-full-cm)">
                <path d="M 200 0 L 620 0 C 700 70, 700 170, 630 230 C 540 310, 350 310, 220 250 C 90 190, 60 80, 200 0 Z" fill="#2B4BA0" opacity="0.55" />
              </g>
              <g filter="url(#riso-full-cm)" style={{ mixBlendMode: 'multiply' }}>
                <path d="M 1200 400 C 1300 320, 1420 300, 1480 340 L 1480 600 L 800 600 C 840 520, 960 460, 1200 400 Z" fill="#F2A12E" opacity="0.5" />
              </g>
              <rect width="1440" height="600" filter="url(#paperGrain-cm)" opacity=".15" />
            </svg>
          </div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
                  ...
                  <div>
                    <p style={{ fontFamily: 'var(--f-serif)', fontSize: '18px', fontWeight: 400, color: 'var(--texte)', marginBottom: '6px' }}>
                      Votre guide « La Colère, Enfin Apprivoisée » arrive par email
                    </p>
...
export default GuideColereMerci;
