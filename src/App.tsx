...
// Guide arrêt du tabac (landing page isolée)
...
// Guide carrière (landing page isolée)
const GuideCarriere = lazy(() => import("@/pages/GuideCarriere"));
const GuideCarriereMerci = lazy(() => import("@/pages/GuideCarriereMerci"));
...
// Pages tarifs, avis clients, contact et FAQ
      ...
      <AuthProvider>
        ...
        <Suspense fallback={<div className="flex items-center justify-center min-h-screen"><div className="animate-spin rounded-full h-32 w-32 border-b-2 border-nova-blue"></div></div>}>
          <Routes>
            ...
            <Route path="/guide-carriere" element={<GuideCarriere />} />
            <Route path="/guide-carriere/merci" element={<GuideCarriereMerci />} />
