    ...
    <div className="quiz-card max-w-3xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <p className="text-xs text-gray-500 text-center">
          En soumettant ce formulaire, vous acceptez de recevoir vos résultats et des informations sur La Formation par email. Je respecte votre vie privée et ne partagerai jamais vos données.
        </p>
      </form>
    </div>
  );
