      ...
      <div className="absolute bottom-20 md:bottom-24 left-0 right-0 z-10">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl w-full">
            ...
            <h1 className="text-lg sm:text-xl md:text-2xl font-semibold text-white/90 mb-3 md:mb-4 drop-shadow-lg">Cabinet d'hypnothérapie à Paris 4ème – Alain Zenatti, Maître Praticien en Hypnose Ericksonienne</h1>
