...
const RelatedArticles: React.FC<RelatedArticlesProps> = ({
  ...
  // Clé partagée avec BlogIndex et ArticlePage — utilise le cache existant
  ...
  const articlesArray: Article[] = result?.data ?? [];
  ...
  const relatedArticles = [...categorized, ...others].slice(0, maxArticles);
